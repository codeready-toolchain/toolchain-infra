...
[source]
----
wget https://mirror.openshift.com/pub/openshift-v4/clients/ocp/latest/openshift-install-linux-4.5.4.tar.gz -P /tmp/
tar -xvf /tmp/openshift-install-linux-4.5.4.tar.gz --directory /tmp
