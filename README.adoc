...
If you want to collect logs for all pods on the cluster, you can run the following script which will take care 
of installting the Cluster Logging and Elasticsearch operators, and configure all the pieces (Fluentd, Collector, Elasticsearch and Kibana).
